...
function Hero() {
  return (
    <div className="text-center px-4 pt-14">
      ...
      <Link href="/rentals"><button className="text-white rounded-lg shadow-2xl border-x-4 mb-6 border border-white p-2 w-[80vw] ">Browse Rentals <ArrowRight className="inline-block" /></button></Link>
    </div>
  )
}
